...
Route::get('bookings', [MainIndexController::class, 'bookings'])->name('bookings');
Route::post('bookings-store', [MainIndexController::class, 'bookingsStore'])->name('bookings.store');
Route::get('packages', [MainIndexController::class, 'packages'])->name('packages');
Route::get('cart', [MainIndexController::class, 'cart'])->name('cart');
Route::get('checkout', [MainIndexController::class, 'checkout'])->name('checkout');
Route::get('testimonial', [MainIndexController::class, 'testimonial'])->name('testimonial');
Route::get('time-table', [MainIndexController::class, 'timeTable'])->name('time-table');
