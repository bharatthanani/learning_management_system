                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="page-banner-content text-center">
                                <h3 class="page-banner-heading text-white pb-15">{{__('Instructor')}}</h3>

                                <!-- Breadcrumb Start-->
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item font-14"><a href="{{ url('/') }}">{{__('Home')}}</a></li>
                                        <li class="breadcrumb-item font-14 active" aria-current="page">{{__('Instructor')}}</li>
                                    </ol>
                                </nav>
                                <!-- Breadcrumb End-->
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="counter-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 counter-content">
                                ...
                                <p class="text-uppercase font-14 font-medium color-gray mt-2">{{ __('Students') }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Counter Item End-->
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="counter-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 counter-content">
                                ...
                                <p class="text-uppercase font-14 font-medium color-gray mt-2">{{ __('Enrollments') }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Counter Item End-->
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="counter-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 counter-content">
                                ...
                                <p class="text-uppercase font-14 font-medium color-gray mt-2">{{ __('Instructor') }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Counter Item End-->
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="counter-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 counter-content">
                                ...
                                <p class="text-uppercase font-14 font-medium color-gray mt-2">{{ __('Satisfaction') }}</p>
                            </div>
                        </div>
                    </div>
                    <!-- Counter Item End-->
