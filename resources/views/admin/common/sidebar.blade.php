<div class="sidebar__area">
    ...
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        @can('packages')
            <li class="{{ @$navPackageParentActiveClass }}">
                <a class="has-arrow" href="#">
                    <span class="iconify" data-icon="ic:twotone-support-agent"></span>
                    <span>{{__('Packages')}}</span>
                </a>
                <ul class="">
                    <li class="{{ @$subNavPackageIndexActiveClass }}">
                        <a href="{{ route('packages.packages.add') }}">
                            <i class="fa fa-circle"></i>
                            <span> {{__('Add Packages')}} </span>
                        </a>
                    </li>
                    <li class="{{ @$subNavPackageIndexActiveClass }}">
                        <a href="{{ route('packages.packages.index') }}">
                            <i class="fa fa-circle"></i>
        ...
        @endcan
           ...
           @can('teacher-profile')
            <li class="{{ @$navTeacherProfileParentActiveClass }}">
                <a class="has-arrow" href="#">
                    <span class="iconify" data-icon="ic:twotone-support-agent"></span>
                    <span>{{__('Teacher Profile')}}</span>
                </a>
                <ul class="">
                    <li class="{{ @$subNavTeacherProfileIndexActiveClass }}">
                        <a href="{{ route('teacher-profile.update') }}">
                            <i class="fa fa-circle"></i>
                            <span> {{__('View')}} </span>
                        </a>
                    </li>
