                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.about.gallery-area.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="custom-form-group mb-3 row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="gallery_area_subtitle" id="gallery_area_subtitle" value="{{ @$aboutUsGeneral->gallery_area_subtitle }}"
                                           class="form-control" placeholder="Type gallery area title">
                             ...
                             <div class="custom-form-group mb-3 row">
                                <label for="gallery_area_desc" class="col-lg-3 text-lg-right text-black"> {{ __('Gallery Area Description') }} </label>
                                <div class="col-lg-9">
                                    <textarea name="gallery_area_desc" class="form-control" rows="5" id="gallery_area_desc">{{ @$aboutUsGeneral->gallery_area_desc }}</textarea>
                                    @if ($errors->has('gallery_area_desc'))
                                        <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('gallery_area_desc') }}</span>
                                    @endif
                                </div>
                            </div>
                         ...
                         {{--   <div class="custom-form-group mb-3 row">
                            ...
                            <div class="custom-form-group mb-3 row">
                                <label class="col-lg-3">{{ __('Gallery Image') }}</label>
                                <div class="col-lg-5">
                                    <div class="upload-img-box">
