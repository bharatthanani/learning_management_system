            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="customers__area bg-style mb-30">
                        ...
                        <form action="{{route('packages.packages.update')}}" method="post" class="form-horizontal">
                            @csrf
                            <input name="id" type="hidden" value="{{$package_data->id}}" />
                           <div class="input__group mb-25">
                                <label>{{ __('Title') }} <span class="text-danger">*</span></label>
                                <input type="text" name="title" value="{{ $package_data->title ?? old('title') }}" />
                             ...
                             <div class="input__group mb-25">
                                ...
                                <input type="text" name="sub_title" value="{{ $package_data->sub_title ?? old('sub_title') }}" />
                             ...
                             <div class="input__group mb-25">
                                ...
                                <input type="number" name="price" value="{{ $package_data->price ?? old('price') }}" />
                             ...
                             <div class="input__group mb-25">
                                ...
                                <input type="number" name="real_price" value="{{ $package_data->real_price ?? old('real_price') }}" />
                            ...
                            <div class="input__group mb-25">
                                ...
                                <textarea name="description" id="summernote">{{ $package_data->description ?? old('description') }}</textarea>
