                       ...
                       <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-6">
                          <div class="page-banner-content text-center balance ">
                              <div class="banner-all-text">
                                 <h3 class="page-banner-heading text-white pb-15 secondary-banner-text"><?php echo e(__('About Us')); ?></h3> 
                              </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                            <div class="sec-two-balane h-100">
                                <a data-aos="zoom-out-left" href="javascript:;"> <img class="oner-sec-img img-fluid"
                                        src="<?php echo e(getImageFile($data['aboutUsGeneral']->gallery_second_image)); ?>" alt=""></a>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                            <div class="sec-two-balane h-100">
                                <div data-aos="zoom-in" class="onwners-porf-alltext">
                                    <h6 class="owner-prf-primary-text"><?php echo e($data['aboutUsGeneral']->gallery_area_subtitle); ?></h6>

                                    <h1 class="owner-prf-secondary-text"><?php echo e($data['aboutUsGeneral']->gallery_area_title); ?></h1>
                                    <div>
                                        <?php echo $data['aboutUsGeneral']->gallery_area_desc; ?>

                                    </div>
                                    <!--<p class="owner-prf-sub-secondory-text"><?php echo $data['aboutUsGeneral']->gallery_area_desc; ?></p>-->
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customweb/public_html/lana.customweb.digital/resources/views/frontend/about.blade.php ENDPATH**/ ?>