                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="<?php echo e(route('settings.general_setting.cms.update')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="top_instructor_logo" class="col-lg-3"><?php echo e(__('Logo')); ?></label>
                                <div class="col-lg-2">
                                    <div class="upload-img-box">
                                        <?php if(get_option('top_instructor_logo') != ''): ?>
                                            <img src="<?php echo e(getImageFile(get_option('top_instructor_logo'))); ?>">
                                        <?php else: ?>
                                            <img src="">
                                        <?php endif; ?>
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="top_instructor_title" class="col-lg-3"><?php echo e(__('Top Instructor Title')); ?> <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="top_instructor_title" id="top_instructor_title" value="<?php echo e(get_option('top_instructor_title')); ?>" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label for="top_instructor_subtitle" class="col-lg-3"><?php echo e(__('Top Instructor Subtitle')); ?> <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="top_instructor_subtitle" id="top_instructor_subtitle" value="<?php echo e(get_option('top_instructor_subtitle')); ?>" class="form-control" required>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customweb/public_html/lana.customweb.digital/resources/views/admin/application_settings/home/top-instructor-section.blade.php ENDPATH**/ ?>