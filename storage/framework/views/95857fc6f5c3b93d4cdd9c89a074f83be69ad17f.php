                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                         ...
                         <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <div class="content-box">
                                ...
                                <p class="para">Impel Academics is an initiative by an Iraqi-American Tutor brought up in Jordan, Lana, who has taught at many different international schools with different curriculums. Lana also has many degrees in Special Education and Teaching English as a second language, which makes her capable of being personable and catering to the student's individual needs. </p>
                                <p class="para">She works hard with the students in order to empower them and not just follow a curriculum that can make things dry. She has summoned all the essential teaching material from around the World at Impel Academics for the students to make the lessons enjoyable and beneficial. From general knowledge, functional English, everyday English, reading, and comprehension to grade 1-8 Mathematics, Lana covers all the academic courses at Impel Academics to build the strong educational foundations of her students.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <li data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine"
                                        ...
                                        <div class="row">
                                            ...
                                            <li class="lang-pd">
                                                ...
                                                <p class="lang-list-prm-txt">The courses at Impel Academics are economical and easy to get, exclusively for the students looking to learn in a new and friendly environment.</p>
                                            </li>
                                        </ul>
                                            </div>
                                            <div class="col-lg-6 col-12">
                                            ...
                                            <li class="lang-pd">
                                                ...
                                                <p class="lang-list-prm-txt">Course completion time at Impel Academics is designed to make it adjustable for the students to enroll and learn effectively.</p>
                                            </li>
                                        </ul>
                                            </div>
                                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-11">
                    <div class="main-imple-head-txt">
                        <h1 class="imple-head-text">How To Join Impel Academics?</h1>
                    </div>
                    <div class="row gy-4">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8">
                            ...
                            <div class="item">
                                <div class="testimonial-content">
                                    ...
                                    <div class="para">
                                        <p class="tstipara">"I was looking for an "English Reading & Comprehension" course for my daughter, and I discovered Impel Academics. The fee is not too much, and you can be sure that you will ace your lessons as the Tutor tests you frequently to authenticate clarity at the end of each session. I found Lana very reliable and respectable, as my daughter had a great time in her classes. Really Satisfied!".
                                        </p>
                                    </div>
                                    <div class="user-name">
                            ...
                            <div class="item">
                                <div class="testimonial-content">
                                    ...
                                    <div class="para">
                                        <p class="tstipara">"I've been trying to learn simple English vocabulary from a number of sources, such as self-study, apps, different online learning programs, high school, and college. But by far, the experience with Impel Academics has been the best. I've advanced more quickly with my tutor in this school than I ever have. Her teaching method is fascinating, and she helps you design a study program that works best for you. Great Experience!"
                                        </p>
                                    </div>
                                    <div class="user-name">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customweb/public_html/lana.customweb.digital/resources/views/frontend/home/home.blade.php ENDPATH**/ ?>