                ...
                <div class="col-md-12">
                    <div class="customers__area bg-style mb-30">
                        <div class="item-title d-flex justify-content-between">
                            <h2><?php echo e(__('Approved Courses')); ?></h2>
                        </div>
                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            ...
                                            <div class="action__buttons">
                                                ...
                                                <a href="<?php echo e(route('admin.course.status-change', [$course->uuid, 3])); ?>" class="btn-action hold-btn mr-30" title="Make as Hold">
                                                    <?php echo e(__('Hold')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Nabu\resources\views/admin/course/approved.blade.php ENDPATH**/ ?>